 ...
 * Modified by YoungHoonKim on 2016-11-26.
 */

import android.graphics.Bitmap;

/**
 클래스명 : public class MySellingListItem
 주된기능 : 내가 판 책 Recyclerview에 출력되는 제목 저자 출판사 판매,대여 여부 data를 반환해 보이게하는 기능
...
public class MySellingListItem {
    private int bookid;
